...
namespace FMF.ConsoleInputGuard.Tests;

public class ProjectSanityTests
{
    private static readonly string ProjectFile = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "FMF.ConsoleInputGuard.csproj"));
